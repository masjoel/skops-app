...
//                   children: [
//                     // Text(
//                     //   "${product.quantity} x ${product.product.price.periodFormat}",
//                     // ),
//                     Text(
//                       product.product.isDiscount
//                           ? "${product.quantity} x ${(product.product.price - product.product.discount * product.product.price * 0.01).toInt().currencyFormatRp}"
//                           : "${product.quantity} x ${(product.product.price - product.product.discount).toInt().currencyFormatRp}",
//                     ),
//                     Text(
//                       // "= ${(product.quantity * product.product.price).periodFormat}",
//                       product.product.isDiscount
//                           ? "= ${(product.quantity * (product.product.price - product.product.discount * product.product.price * 0.01).toInt()).periodFormat}"
//                           : "= ${(product.quantity * (product.product.price - product.product.discount)).periodFormat}",
//                     ),
//                   ],
//                 ),
//               ],

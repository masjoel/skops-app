...
//   static final BtPrint instance = BtPrint._init();
...
//           text: product.product.isDiscount
//               ? "${product.quantity} x ${(product.product.price - product.product.discount * product.product.price * 0.01).toInt().periodFormat}"
//               : "${product.quantity} x ${(product.product.price - product.product.discount).toInt().periodFormat}",
//           width: 8,
//           styles: const PosStyles(align: PosAlign.left),
//         ),
//         PosColumn(
